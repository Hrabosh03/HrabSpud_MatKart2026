...
Nad rámec určení polohy byly vypočteny doplňkové charakteristiky zobrazení. Délkové zkreslení $m-1$ bylo stanoveno na základě rovnice pro měřítko délek na kuželi, tedy pouze ze zobrazení z Gaussovy koule do roviny. Meridiánová konvergence $C$ byla určena jako rozdíl mezi rovinnou konvergencí na kuželi a sférickou konvergencí na Gaussově kouli.
...
$P_1$ & $-9,7271 \cdot 10^{-5}$ & $-9,73$ & $-7,7644$ \\ \hline
$P_2$ & $-9,6910 \cdot 10^{-5}$ & $-9,69$ & $-7,8299$ \\ \hline
\end{tabular}
