...
#Pole
uk = 39.567070378372 * pi/180  # Příklad (Španělsko) - zeměpisná šířka středu
vk = -7.935935505136 * pi/180  # Příklad (Španělsko) - zeměpisná délka středu

#Furthest point
u1 = 36.993511000133 * pi/180  # Zeměpisná šířka okrajového bodu
v1 = -8.948009999961* pi/180  # Zeměpisná délka okrajového bodu
...
plt.title("Azimuthal conformal projection - Portugal")
plt.axis('equal') 
plt.show()
