...
#Pole
uk = 15.478254715409 * pi/180
vk = -7.722952584256 * pi/180 

#Northernmost point
u1 = 42.435138702089 *pi/180
v1 = 3.174304962604 *pi/180

#Southernmost point
u2 = 35.999584198552 *pi/180
v2 = -5.609027861846 *pi/180
...
#Rotation calculation (Spain's approximate center)
u_c, v_c = 40.0 * pi/180, -4.0 * pi/180 
u_n, v_n = 41.0 * pi/180, -4.0 * pi/180 
...
#Adjusted grid spacing and bounding box 
Du, dv = 1.0, 0.1 
Dv, du = 1.0, 0.1 
umin, umax = 35.0, 44.0  
vmin, vmax = -10.0, 5.0  
...
plt.title("Lambert conformal conic projection - Spain")
plt.axis('equal') 
plt.show()