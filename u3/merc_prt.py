...
u1 = 42.131106788011*pi/180
v1 = -7.647128198609*pi/180
u2 = 36.978517274986*pi/180
v2 = -8.505209114352*pi/180

#Westernmost point
u3 = 39.476592917041*pi/180
v3 = -9.547042810083*pi/180

#Easternmost point
u4 = 38.208320618428*pi/180
v4 = -6.931529999836*pi/180
...
R = 1
# UV to SD 
u_c, v_c = 39.5 * pi/180, -8.0 * pi/180  # Approximate center of Portugal
...
plt.title("Mercator conformal projection - Portugal")
plt.axis('equal') 
plt.show()
